---
page_title: "okta_group_role_assignment_group_membership_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment Group Membership Admin resource.
---

# okta_group_role_assignment_group_membership_admin (Resource)

Manages an Okta Group Role Assignment Group Membership Admin.

## Example Usage

```hcl
resource "okta_group_role_assignment_group_membership_admin" "example" {
  group_id = "<group-id>"
  type = "<type>"
...
```shell
terraform import okta_group_role_assignment_group_membership_admin.example <group_id> <id>
```
