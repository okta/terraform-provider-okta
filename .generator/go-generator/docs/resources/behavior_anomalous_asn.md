---
page_title: "okta_behavior_anomalous_asn Resource - terraform-provider-okta"
description: |-
  Manages an Okta Behavior Anomalous Asn resource.
---

# okta_behavior_anomalous_asn (Resource)

Manages an Okta Behavior Anomalous Asn.

## Example Usage

```hcl
resource "okta_behavior_anomalous_asn" "example" {
  type = "<type>"
  name = "Example Name"
