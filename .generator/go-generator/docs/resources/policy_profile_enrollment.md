---
page_title: "okta_policy_profile_enrollment Resource - terraform-provider-okta"
description: |-
  Manages an Okta Policy Profile Enrollment resource.
---

# okta_policy_profile_enrollment (Resource)

Manages an Okta Policy Profile Enrollment.
