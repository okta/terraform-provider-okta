---
page_title: "okta_application_basic_auth Resource - terraform-provider-okta"
description: |-
  Manages an Okta Application Basic Auth resource.
---

# okta_application_basic_auth (Resource)

Manages an Okta Application Basic Auth.
