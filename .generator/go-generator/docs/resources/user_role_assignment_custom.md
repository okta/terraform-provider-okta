---
page_title: "okta_user_role_assignment_custom Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Role Assignment Custom resource.
---

# okta_user_role_assignment_custom (Resource)

Manages an Okta User Role Assignment Custom.
...
```shell
terraform import okta_user_role_assignment_custom.example <user_id> <id>
```
