---
page_title: "okta_user_factor_web Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Web resource.
---

# okta_user_factor_web (Resource)

Manages an Okta User Factor Web.
...
```shell
terraform import okta_user_factor_web.example <user_id> <id>
```
