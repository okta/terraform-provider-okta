---
page_title: "okta_group_role_assignment_app_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment App Admin resource.
---

# okta_group_role_assignment_app_admin (Resource)

Manages an Okta Group Role Assignment App Admin.

## Example Usage

```hcl
resource "okta_group_role_assignment_app_admin" "example" {
  group_id = "<group-id>"
  type = "<type>"
...
```shell
terraform import okta_group_role_assignment_app_admin.example <group_id> <id>
```
