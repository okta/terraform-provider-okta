---
page_title: "okta_user_role_assignment_app_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Role Assignment App Admin resource.
---

# okta_user_role_assignment_app_admin (Resource)

Manages an Okta User Role Assignment App Admin.

## Example Usage

```hcl
resource "okta_user_role_assignment_app_admin" "example" {
  user_id = "<user-id>"
  type = "<type>"
...
```shell
terraform import okta_user_role_assignment_app_admin.example <user_id> <id>
```
