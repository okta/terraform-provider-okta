---
page_title: "okta_user_factor_question Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Question resource.
---

# okta_user_factor_question (Resource)

Manages an Okta User Factor Question.
...
```shell
terraform import okta_user_factor_question.example <user_id> <id>
```
