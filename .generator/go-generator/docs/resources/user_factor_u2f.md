---
page_title: "okta_user_factor_u2f Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor U2f resource.
---

# okta_user_factor_u2f (Resource)

Manages an Okta User Factor U2f.
...
```shell
terraform import okta_user_factor_u2f.example <user_id> <id>
```
