---
page_title: "okta_group_role_assignment_help_desk_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment Help Desk Admin resource.
---

# okta_group_role_assignment_help_desk_admin (Resource)

Manages an Okta Group Role Assignment Help Desk Admin.

## Example Usage

```hcl
resource "okta_group_role_assignment_help_desk_admin" "example" {
  group_id = "<group-id>"
  type = "<type>"
...
```shell
terraform import okta_group_role_assignment_help_desk_admin.example <group_id> <id>
```
