---
page_title: "okta_behavior_anomalous_device Resource - terraform-provider-okta"
description: |-
  Manages an Okta Behavior Anomalous Device resource.
---

# okta_behavior_anomalous_device (Resource)

Manages an Okta Behavior Anomalous Device.

## Example Usage

```hcl
resource "okta_behavior_anomalous_device" "example" {
  type = "<type>"
  name = "Example Name"
