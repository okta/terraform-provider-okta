---
page_title: "okta_group_role_assignment_api_access_management_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment Api Access Management Admin resource.
---

# okta_group_role_assignment_api_access_management_admin (Resource)

Manages an Okta Group Role Assignment Api Access Management Admin.

## Example Usage

```hcl
resource "okta_group_role_assignment_api_access_management_admin" "example" {
  group_id = "<group-id>"
  type = "<type>"
...
```shell
terraform import okta_group_role_assignment_api_access_management_admin.example <group_id> <id>
```
