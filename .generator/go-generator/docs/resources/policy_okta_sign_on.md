---
page_title: "okta_policy_okta_sign_on Resource - terraform-provider-okta"
description: |-
  Manages an Okta Policy Okta Sign On resource.
---

# okta_policy_okta_sign_on (Resource)

Manages an Okta Policy Okta Sign On.

## Example Usage

```hcl
resource "okta_policy_okta_sign_on" "example" {
  type = "<type>"
  name = "Example Name"
