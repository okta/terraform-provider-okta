---
page_title: "okta_policy_post_auth_session Resource - terraform-provider-okta"
description: |-
  Manages an Okta Policy Post Auth Session resource.
---

# okta_policy_post_auth_session (Resource)

Manages an Okta Policy Post Auth Session.

## Example Usage

```hcl
resource "okta_policy_post_auth_session" "example" {
  type = "<type>"
  name = "Example Name"
