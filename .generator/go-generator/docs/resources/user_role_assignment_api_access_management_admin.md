---
page_title: "okta_user_role_assignment_api_access_management_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Role Assignment Api Access Management Admin resource.
---

# okta_user_role_assignment_api_access_management_admin (Resource)

Manages an Okta User Role Assignment Api Access Management Admin.
...
```shell
terraform import okta_user_role_assignment_api_access_management_admin.example <user_id> <id>
```
