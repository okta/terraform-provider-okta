---
page_title: "okta_group_role_assignment_custom Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment Custom resource.
---

# okta_group_role_assignment_custom (Resource)

Manages an Okta Group Role Assignment Custom.
...
```shell
terraform import okta_group_role_assignment_custom.example <group_id> <id>
```
