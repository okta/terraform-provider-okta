---
page_title: "okta_group_role_assignment_report_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment Report Admin resource.
---

# okta_group_role_assignment_report_admin (Resource)

Manages an Okta Group Role Assignment Report Admin.

## Example Usage

```hcl
resource "okta_group_role_assignment_report_admin" "example" {
  group_id = "<group-id>"
  type = "<type>"
...
```shell
terraform import okta_group_role_assignment_report_admin.example <group_id> <id>
```
