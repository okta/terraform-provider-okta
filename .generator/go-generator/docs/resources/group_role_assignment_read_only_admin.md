---
page_title: "okta_group_role_assignment_read_only_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment Read Only Admin resource.
---

# okta_group_role_assignment_read_only_admin (Resource)

Manages an Okta Group Role Assignment Read Only Admin.

## Example Usage

```hcl
resource "okta_group_role_assignment_read_only_admin" "example" {
  group_id = "<group-id>"
  type = "<type>"
...
```shell
terraform import okta_group_role_assignment_read_only_admin.example <group_id> <id>
```
