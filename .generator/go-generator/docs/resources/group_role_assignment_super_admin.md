---
page_title: "okta_group_role_assignment_super_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta Group Role Assignment Super Admin resource.
---

# okta_group_role_assignment_super_admin (Resource)

Manages an Okta Group Role Assignment Super Admin.
...
```shell
terraform import okta_group_role_assignment_super_admin.example <group_id> <id>
```
