---
page_title: "okta_policy_device_signal_collection Resource - terraform-provider-okta"
description: |-
  Manages an Okta Policy Device Signal Collection resource.
---

# okta_policy_device_signal_collection (Resource)

Manages an Okta Policy Device Signal Collection.

## Example Usage

```hcl
resource "okta_policy_device_signal_collection" "example" {
  type = "<type>"
  name = "Example Name"
