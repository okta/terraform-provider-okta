---
page_title: "okta_application_auto_login Resource - terraform-provider-okta"
description: |-
  Manages an Okta Application Auto Login resource.
---

# okta_application_auto_login (Resource)

Manages an Okta Application Auto Login.
...
- `login_url` (String) Primary URL of the sign-in page for this app
...
- `name` (String) A unique key is generated for the custom SWA app instance when you use AUTO_LOGIN `signOnMode`.
