---
page_title: "okta_user_factor_push Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Push resource.
---

# okta_user_factor_push (Resource)

Manages an Okta User Factor Push.
...
```shell
terraform import okta_user_factor_push.example <user_id> <id>
```
