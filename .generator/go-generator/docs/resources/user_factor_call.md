---
page_title: "okta_user_factor_call Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Call resource.
---

# okta_user_factor_call (Resource)

Manages an Okta User Factor Call.

## Example Usage

```hcl
resource "okta_user_factor_call" "example" {
  user_id = "<user-id>"
...
```shell
terraform import okta_user_factor_call.example <user_id> <id>
```
