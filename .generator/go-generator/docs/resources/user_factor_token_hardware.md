---
page_title: "okta_user_factor_token_hardware Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Token Hardware resource.
---

# okta_user_factor_token_hardware (Resource)

Manages an Okta User Factor Token Hardware.
...
- `pass_code` (String) OTP for the current time window
...
```shell
terraform import okta_user_factor_token_hardware.example <user_id> <id>
```
