---
page_title: "okta_user_role_assignment_super_admin Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Role Assignment Super Admin resource.
---

# okta_user_role_assignment_super_admin (Resource)

Manages an Okta User Role Assignment Super Admin.
...
```shell
terraform import okta_user_role_assignment_super_admin.example <user_id> <id>
```
