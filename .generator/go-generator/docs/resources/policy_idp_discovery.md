---
page_title: "okta_policy_idp_discovery Resource - terraform-provider-okta"
description: |-
  Manages an Okta Policy Idp Discovery resource.
---

# okta_policy_idp_discovery (Resource)

Manages an Okta Policy Idp Discovery.

## Example Usage

```hcl
resource "okta_policy_idp_discovery" "example" {
  type = "<type>"
  name = "Example Name"
