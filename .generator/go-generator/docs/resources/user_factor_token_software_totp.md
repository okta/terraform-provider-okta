---
page_title: "okta_user_factor_token_software_totp Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Token Software Totp resource.
---

# okta_user_factor_token_software_totp (Resource)

Manages an Okta User Factor Token Software Totp.
...
```shell
terraform import okta_user_factor_token_software_totp.example <user_id> <id>
```
