---
page_title: "okta_user_factor_webauthn Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Webauthn resource.
---

# okta_user_factor_webauthn (Resource)

Manages an Okta User Factor Webauthn.

## Example Usage

```hcl
resource "okta_user_factor_webauthn" "example" {
  user_id = "<user-id>"
...
```shell
terraform import okta_user_factor_webauthn.example <user_id> <id>
```
