---
page_title: "okta_user_factor_sms Resource - terraform-provider-okta"
description: |-
  Manages an Okta User Factor Sms resource.
---

# okta_user_factor_sms (Resource)

Manages an Okta User Factor Sms.

## Example Usage

```hcl
resource "okta_user_factor_sms" "example" {
  user_id = "<user-id>"
...
```shell
terraform import okta_user_factor_sms.example <user_id> <id>
```
