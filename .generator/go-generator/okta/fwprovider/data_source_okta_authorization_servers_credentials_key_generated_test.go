...
func TestAccDataSourceOktaAuthorizationServersCredentialsKey_read(t *testing.T) {
	mgr := acctest.NewFixtureManager("data-sources", "okta_authorization_servers_credentials_key", t.Name())
	config := mgr.GetFixtures("datasource.tf", t)
	resourceName := "data.okta_authorization_servers_credentials_key.test"
