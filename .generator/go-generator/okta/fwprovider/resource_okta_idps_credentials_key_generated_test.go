...
func TestAccIdpsCredentialsKey_basic(t *testing.T) {
	mgr := acctest.NewFixtureManager("resources", "okta_idps_credentials_key", t.Name())
	config := mgr.GetFixtures("basic.tf", t)
	resourceName := fmt.Sprintf("%s.test", "okta_idps_credentials_key")
