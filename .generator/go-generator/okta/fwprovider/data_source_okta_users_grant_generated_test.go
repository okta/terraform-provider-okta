...
func TestAccDataSourceOktaUsersGrant_read(t *testing.T) {
	mgr := acctest.NewFixtureManager("data-sources", "okta_users_grant", t.Name())
	config := mgr.GetFixtures("datasource.tf", t)
	resourceName := "data.okta_users_grant.test"
