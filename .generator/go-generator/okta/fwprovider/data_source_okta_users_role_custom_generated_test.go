...
func TestAccDataSourceOktaUsersRoleCustom_read(t *testing.T) {
	mgr := acctest.NewFixtureManager("data-sources", "okta_users_role_custom", t.Name())
	config := mgr.GetFixtures("datasource.tf", t)
	resourceName := "data.okta_users_role_custom.test"
