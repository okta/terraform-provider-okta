...
func TestAccEmailServerOauth2JwtBearerGrant_basic(t *testing.T) {
	mgr := acctest.NewFixtureManager("resources", "okta_email_server_oauth2_jwt_bearer_grant", t.Name())
	config := mgr.GetFixtures("basic.tf", t)
	resourceName := fmt.Sprintf("%s.test", "okta_email_server_oauth2_jwt_bearer_grant")
