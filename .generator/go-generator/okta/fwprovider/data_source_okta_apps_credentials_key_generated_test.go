...
func TestAccDataSourceOktaAppsCredentialsKey_read(t *testing.T) {
	mgr := acctest.NewFixtureManager("data-sources", "okta_apps_credentials_key", t.Name())
	config := mgr.GetFixtures("datasource.tf", t)
	resourceName := "data.okta_apps_credentials_key.test"
