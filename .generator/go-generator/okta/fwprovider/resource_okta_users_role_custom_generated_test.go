...
func TestAccUsersRoleCustom_basic(t *testing.T) {
	mgr := acctest.NewFixtureManager("resources", "okta_users_role_custom", t.Name())
	config := mgr.GetFixtures("basic.tf", t)
	resourceName := fmt.Sprintf("%s.test", "okta_users_role_custom")
