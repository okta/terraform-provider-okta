...
func TestAccGroupsRoleWorkflowsAdmin_basic(t *testing.T) {
	mgr := acctest.NewFixtureManager("resources", "okta_groups_role_workflows_admin", t.Name())
	config := mgr.GetFixtures("basic.tf", t)
	resourceName := fmt.Sprintf("%s.test", "okta_groups_role_workflows_admin")
