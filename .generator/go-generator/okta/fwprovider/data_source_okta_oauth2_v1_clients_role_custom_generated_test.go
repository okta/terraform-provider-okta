...
func TestAccDataSourceOktaOauth2V1ClientsRoleCustom_read(t *testing.T) {
	mgr := acctest.NewFixtureManager("data-sources", "okta_oauth2_v1_clients_role_custom", t.Name())
	config := mgr.GetFixtures("datasource.tf", t)
	resourceName := "data.okta_oauth2_v1_clients_role_custom.test"
