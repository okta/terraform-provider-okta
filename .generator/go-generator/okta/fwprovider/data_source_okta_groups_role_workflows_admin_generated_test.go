...
func TestAccDataSourceOktaGroupsRoleWorkflowsAdmin_read(t *testing.T) {
	mgr := acctest.NewFixtureManager("data-sources", "okta_groups_role_workflows_admin", t.Name())
	config := mgr.GetFixtures("datasource.tf", t)
	resourceName := "data.okta_groups_role_workflows_admin.test"
