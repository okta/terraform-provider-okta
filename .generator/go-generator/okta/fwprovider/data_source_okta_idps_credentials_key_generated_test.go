...
func TestAccDataSourceOktaIdpsCredentialsKey_read(t *testing.T) {
	mgr := acctest.NewFixtureManager("data-sources", "okta_idps_credentials_key", t.Name())
	config := mgr.GetFixtures("datasource.tf", t)
	resourceName := "data.okta_idps_credentials_key.test"
