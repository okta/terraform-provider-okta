...
func TestAccOauth2V1ClientsRoleAppAdmin_basic(t *testing.T) {
	mgr := newFixtureManager("resources", "okta_oauth2_v1_clients_role_app_admin", t.Name())
	config := mgr.GetFixtures("basic.tf", t)
	resourceName := fmt.Sprintf("%s.test", "okta_oauth2_v1_clients_role_app_admin")
