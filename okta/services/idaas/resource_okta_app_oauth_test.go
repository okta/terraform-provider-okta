		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					ensureResourceExists(resourceName, createDoesOAuthAppExist()),
					resource.TestCheckResourceAttr(resourceName, "jwks_uri", "https://example.com/.well-known/jwks.json"),
					resource.TestCheckResourceAttr(resourceName, "token_endpoint_auth_method", "private_key_jwt"),
				),
			},
			{
				Config: config,
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(ecResourceName, "jwks_uri", "https://example.com/.well-known/jwks-ec.json"),
					resource.TestCheckResourceAttr(ecResourceName, "token_endpoint_auth_method", "private_key_jwt"),
				),
			},
		},
	})
