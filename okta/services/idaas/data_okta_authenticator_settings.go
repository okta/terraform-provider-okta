...
var _ datasource.DataSource = (*authenticatorSettingsDataSource)(nil)

func newAuthenticatorSettingsDataSource() datasource.DataSource {
	return &authenticatorSettingsDataSource{}
}

type authenticatorSettingsDataSource struct {
	*config.Config
}

func (d *authenticatorSettingsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	d.Config = dataSourceConfiguration(req, resp)
}

type authenticatorSettingsDataSourceModel struct {
	Id                                   types.String `tfsdk:"id"`
	VerifyKnowledgeSecondWhen2faRequired types.Bool   `tfsdk:"verify_knowledge_second_when_2fa_required"`
}

func (d *authenticatorSettingsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_request_setting_organization"
}

func (d *authenticatorSettingsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *authenticatorSettingsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data authenticatorSettingsDataSourceModel
