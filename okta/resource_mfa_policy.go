...
func resourceMfaPolicy() *schema.Resource {
	return &schema.Resource{
		...
		Create: resourceMfaPolicyCreate,
		Read:   resourceMfaPolicyRead,
		Update: resourceMfaPolicyUpdate,
		Delete: resourceMfaPolicyDelete,
...
func resourceMfaPolicyCreate(d *schema.ResourceData, m interface{}) error {
	...
	return resourceMfaPolicyRead(d, m)
}

func resourceMfaPolicyRead(d *schema.ResourceData, m interface{}) error {
...
func resourceMfaPolicyUpdate(d *schema.ResourceData, m interface{}) error {
	if err := ensureNotDefaultPolicy(d); err != nil {
		return err
	}
...
func resourceMfaPolicyDelete(d *schema.ResourceData, m interface{}) error {
	if err := ensureNotDefaultPolicy(d); err != nil {
		return err
	}
