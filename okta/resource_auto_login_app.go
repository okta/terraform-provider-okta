...
func resourceAutoLoginApp() *schema.Resource {
	return &schema.Resource{
		Create: resourceAutoLoginAppCreate,
		Read:   resourceAutoLoginAppRead,
		Update: resourceAutoLoginAppUpdate,
		Delete: resourceAutoLoginAppDelete,
...
func resourceAutoLoginAppCreate(d *schema.ResourceData, m interface{}) error {
	client := getOktaClientFromMetadata(m)
	app := buildAutoLoginApp(d, m)
	...
	return resourceAutoLoginAppRead(d, m)
}

func resourceAutoLoginAppRead(d *schema.ResourceData, m interface{}) error {
...
func resourceAutoLoginAppUpdate(d *schema.ResourceData, m interface{}) error {
	client := getOktaClientFromMetadata(m)
	app := buildAutoLoginApp(d, m)
...
func resourceAutoLoginAppDelete(d *schema.ResourceData, m interface{}) error {
	client := getOktaClientFromMetadata(m)
...
func buildAutoLoginApp(d *schema.ResourceData, m interface{}) *okta.AutoLoginApplication {
