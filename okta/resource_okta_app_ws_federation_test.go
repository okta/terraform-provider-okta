...
func TestAccAppWSFed_conditionalRequire(t *testing.T) {
	ri := acctest.RandInt()
	config := buildTestWSFedConfigMissingFields(ri)
...
// Ensure conditional require logic causes this plan to fail
func TestAccAppWSFed_invalidURL(t *testing.T) {
	ri := acctest.RandInt()
	config := buildTestWSFedConfigInvalidURL(ri)
...
func TestAccAppWSFed_crud(t *testing.T) {
	ri := acctest.RandInt()
...
func TestAccAppWSFed_preconfigured(t *testing.T) {
	ri := acctest.RandInt()
	mgr := newFixtureManager(appWSFed)
...
func testAppWSFedJson(name, expectedSettingsJSON, expectedLinksJSON string) resource.TestCheckFunc {
...
func TestAccAppWSFed_userGroups(t *testing.T) {
	ri := acctest.RandInt()
	mgr := newFixtureManager(appWSFed)
...
func TestAccAppWSFed_inlineHook(t *testing.T) {
	ri := acctest.RandInt()
	mgr := newFixtureManager(appWSFed)
...
func TestAccAppWSFed_federationBroker(t *testing.T) {
...
func buildTestWSFedConfigMissingFields(rInt int) string {
...
func buildTestWSFedConfigInvalidURL(rInt int) string {
	name := buildResourceName(rInt)
...
func TestAccResourceOktaAppWSFed_timeouts(t *testing.T) {
	ri := acctest.RandInt()
	mgr := newFixtureManager(appWSFed)
	resourceName := fmt.Sprintf("%s.test", appWSFed)
	config := `
...
func TestAccAppWSFed_certdiff(t *testing.T) {
	ri := acctest.RandInt()
	mgr := newFixtureManager(appWSFed)
