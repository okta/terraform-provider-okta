...
func resourceSecurePasswordStoreApp() *schema.Resource {
	return &schema.Resource{
		Create: resourceSecurePasswordStoreAppCreate,
		Read:   resourceSecurePasswordStoreAppRead,
		Update: resourceSecurePasswordStoreAppUpdate,
		Delete: resourceSecurePasswordStoreAppDelete,
...
func resourceSecurePasswordStoreAppCreate(d *schema.ResourceData, m interface{}) error {
	client := getOktaClientFromMetadata(m)
	app := buildSecurePasswordStoreApp(d, m)
	...
	return resourceSecurePasswordStoreAppRead(d, m)
}

func resourceSecurePasswordStoreAppRead(d *schema.ResourceData, m interface{}) error {
...
func resourceSecurePasswordStoreAppUpdate(d *schema.ResourceData, m interface{}) error {
	client := getOktaClientFromMetadata(m)
	app := buildSecurePasswordStoreApp(d, m)
...
func resourceSecurePasswordStoreAppDelete(d *schema.ResourceData, m interface{}) error {
	client := getOktaClientFromMetadata(m)
...
func buildSecurePasswordStoreApp(d *schema.ResourceData, m interface{}) *okta.SecurePasswordStoreApplication {
