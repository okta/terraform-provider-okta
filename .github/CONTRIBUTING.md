...
#### [Bug Reports](https://github.com/terraform-providers/terraform-provider-okta/issues/new?template=Bug_Report.md)
 ...
 - [ ] __Search for possible duplicate reports__: It's helpful to keep bug
   ...
   reports to check if anybody else has reported the same thing. You can [scope
      searches by the label "bug"](https://github.com/terraform-providers/terraform-provider-okta/issues?q=is%3Aopen+is%3Aissue+label%3Abug) to help narrow things down.
...
#### [Feature Requests](https://github.com/terraform-providers/terraform-provider-okta/issues/new?labels=enhancement&template=Feature_Request.md)
 ...
 - [ ] __Search for possible duplicate requests__: It's helpful to keep requests
   ...
   check if anybody else has reported the same thing. You can [scope searches by
      the label "enhancement"](https://github.com/terraform-providers/terraform-provider-okta/issues?q=is%3Aopen+is%3Aissue+label%3Aenhancement) to help narrow things down.
...
#### [Questions](https://github.com/terraform-providers/terraform-provider-okta/issues/new?labels=question&template=Question.md)
...
- [ ] __Prefer Okta Documentation__: Documentation about Okta service features and valid argument values that are likely to update over time should link to Okta service user guides and API references where possible.
...
guidelines.
 ...
 - [ ] __Acceptance tests__: New resources should include acceptance tests
   ...
   approach these.
 - [ ] __Resource Naming__: Resources should be named `okta_<service>_<name>`,
...
- [ ] __Uses Okta Go SDK Types__: Use available SDK structs instead of implementing custom types with indirection.
...
- [ ] __Skips Error() Call with Okta Go SDK Error Objects__: Error objects do not need to have `Error()` called.
...
- [ ] __Excludes Provider Declarations__: Test configurations should not include `provider "okta" {...}` declarations. If necessary, only the provider declarations in `provider_test.go` should be used for multiple account/region or otherwise specialized testing.
...
[website]: https://github.com/terraform-providers/terraform-provider-okta/tree/master/website
