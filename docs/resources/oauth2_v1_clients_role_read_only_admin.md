...
- `type` (String) Discriminator field identifying the variant type. Must be set to "READ_ONLY_ADMIN".
...
```shell
terraform import okta_oauth2_v1_clients_role_read_only_admin.example <client_id>/<id>
```
