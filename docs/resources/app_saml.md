...
### Example to demonstrate usage of acs_endpoints_json
resource "okta_app_saml" "test4" {
  label = "dwdef"
  sso_url= "https://example.com"
  recipient= "https://example.com"
  destination= "https://example.com"
...
- `acs_endpoints_json` (String) ACS endpoints along with custom index in an array called `acs_endpoints_index` inJSON format
